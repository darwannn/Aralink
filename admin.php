...
<div class="mainContent">
    ...
    <div class="table-container">
        <div class="video_menu" id="video_menu">
            <div class="content">
                <div class="content-row">
                    <button type="button" id="video-add-button" data-toggle="modal" data-target="#video-modal"
            ...
            <div id="video-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="video-modalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <form method="post" id="video-form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="linkcode" id="linkcode" value="<?php  echo $classcode?>"
                                    class="form-control" />
                                <div class="modal-footerr text-right">
                                    <input type="hidden" name="video_id" id="video_id" />
                                    <input type="hidden" name="video-operation" id="video-operation" />
                                    <input type="submit" name="video-action" id="video-action" class="btn btn-primaryy"
                                        value="Add" />
        ...
        <div class="subject_menu" id="subject_menu">
            <div class="content">
                <div class="content-row">
                    <button type="button" id="subject-add-button" data-toggle="modal" data-backdrop="static"
                        data-keyboard="false" data-target="#subject-modal" class="btn btn-primaryy my-0  ">
                        <i class="fas fa-plus"></i> Subject</button>
                    <input type="seach" class="form-control searchbarh" id="input-search"
            ...
            <div id="subject-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="subject-modalLabel"
                aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <div class="form-group pb-1">
                                    ...
                                    <input type="hidden" name="subjectcode" id="subjectcode"
                                        value="<?php  echo $classcode?>" class="form-control" />
                                </div>
                                <div class="modal-footerr text-right">
                                    <input type="hidden" name="subject_id" id="subject_id" />
                                    <input type="hidden" name="subject-operation" id="subject-operation" />
                                    <input type="submit" name="subject-action" id="subject-action"
